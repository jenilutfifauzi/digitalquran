...
<html lang="en">
    ...
    <body>
        <!-- Header-->
        <header class="py-5">
            <div data-aos="fade-down" data-aos-easing="linear"  data-aos-duration="550" class="container px-lg-5 ">
                <div class="p-4 p-lg-5 bg-light rounded-2 text-center ">
                    <div class="m-4 m-lg-5">
                        ...
                        <center><button class="btn btn-warning anim">yuk baca</button></center>
                    </div>
                </div>
            </div>
        </header>
